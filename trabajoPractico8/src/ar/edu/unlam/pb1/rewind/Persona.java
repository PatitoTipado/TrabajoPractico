...
public class Persona {
	...
	public static boolean pesoValido(int ingresarPeso) {
		return ingresarPeso > 0 && ingresarPeso < 200;
	}

	public static boolean edadValida(int ingresarEdad) {
		return ingresarEdad > 0 && ingresarEdad < 120;
	}
